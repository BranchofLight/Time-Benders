class MusicPlayer
{
  ...
  // Tracklist duration parameter must be no larger than the song file or it will repeat indefinitely!
  public void initializeTrackList()
  {
    ...
    samples[8] = new Sample("/sounds/Imagine Dragons - Radioactive.wav");
    trackList[8] = new Song(samples[8], "radioactive", "imagine dragons", "single", 184000);
  }
