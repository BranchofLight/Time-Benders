...
{  
  ...
  public Store()
  {
    ...
    /*powerups[0] = new PowerUp("Rapid Fire", 0, 30000);
    powerups[1] = new PowerUp("Rock Seekers", 0, 10000);
    powerups[2] = new PowerUp("RGB Bullet", 0, 10000);
    powerups[3] = new PowerUp("Laser Pointer", 0, 30000);
    powerups[4] = new PowerUp("Insta-Brake", 0, 20000);
    powerups[5] = new PowerUp("Supernova", 0, 0);
    powerups[6] = new PowerUp("Floating Mine", 0, 0);
    powerups[7] = new PowerUp("Spreader", 0, 20000);*/
  }
